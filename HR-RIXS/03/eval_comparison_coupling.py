...
from parameter import rml_file_name_bessy3_HRRIXS_myV2, rml_file_name_bessy3_HRRIXS_myV3
from parameter import rml_file_name_bessy3_HRRIXS_JV, rml_file_name_bessy3_HRRIXS_myV4
from parameter import rml_file_name_bessy3_HRRIXS_myV5
...
rml_comparison_list = {}
rml_comparison_list[rml_file_name_bessy3_HRRIXS_myV2]     = 2
rml_comparison_list[rml_file_name_bessy3_HRRIXS_myV3]     = 2
rml_comparison_list[rml_file_name_bessy3_HRRIXS_myV4]     = 2
rml_comparison_list[rml_file_name_bessy3_HRRIXS_myV5]     = 2
rml_comparison_list[rml_file_name_bessy3_HRRIXS_JV]       = 2
...
fig.suptitle(f"BESSYIII PGM beamline comparison")
