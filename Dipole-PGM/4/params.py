...
hb_1200_order       = 1
hb_1200_energy_flux = np.arange(200, 2551,10)
hb_1200_energy_rp   = np.arange(200, 2551,10)
hb_1200_SlitSize    = np.array([0.01])
