...
# BESSY III vert_PGM:
BL_file_path = os.path.join(f'RAYPy_Simulation_vertical_PGM_{amp}', 'DetectorAtFocus_RawRaysOutgoing.csv')
PGM_vert = pd.read_csv(BL_file_path)
PGM_vert['PhotonEnergy'] +=50 # shift for visualization
# BESSY III hor_PGM_M3Para:
BL2_file_path = os.path.join(f'RAYPy_Simulation_horizontal_PGM_{amp}', 'DetectorAtFocus_RawRaysOutgoing.csv')
