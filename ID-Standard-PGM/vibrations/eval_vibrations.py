...
fig.text(0.19, 0.7, 'vert. plane (solid lines)\nhor. plane M3=Para (dashed lines)', fontsize=9, ha='right', va='top', bbox=dict(facecolor='white', alpha=0.8, edgecolor='grey'))
...
# Save the the figure
plt.tight_layout()
plt.savefig('plot/vibrations_comparison.pdf')
plt.show()