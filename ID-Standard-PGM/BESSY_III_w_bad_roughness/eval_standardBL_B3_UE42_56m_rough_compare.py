...
# BL_roughness 0.1 nm:
BL_file_path = os.path.join('RAYPy_Simulation_bessy3_56m_PGM_2Perc_coupl_err_on0_75deg_1200l_V3_0_1nm_rough_Au_FLUX', 'DetectorAtFocus_RawRaysOutgoing.csv')
BL_df = pd.read_csv(BL_file_path)

# BL_roughness 1 nm:
BL1_file_path = os.path.join('RAYPy_Simulation_bessy3_56m_PGM_2Perc_coupl_err_on0_75deg_1200l_V3_1nm_rough_Au_FLUX', 'DetectorAtFocus_RawRaysOutgoing.csv')
BL1_df = pd.read_csv(BL1_file_path)

# BL_roughness 3 nm:
BL2_file_path = os.path.join('RAYPy_Simulation_bessy3_56m_PGM_2Perc_coupl_err_on0_75deg_1200l_V3_3nm_rough_Au_FLUX', 'DetectorAtFocus_RawRaysOutgoing.csv')
...
fig.suptitle('UE42 BESSY III Standard PGM Beamline (56 m), all Au, comparison roughness', size=14)
x_range = [50, 2150]
...
ax7.plot(BL1_df_smoothed['PhotonEnergy'], BL1_df_smoothed['HorizontalFocusFWHM']*1000, label='Horizontal Focus Size', color='orangered', linestyle='dashed')
ax7.plot(BL2_df_smoothed['PhotonEnergy'], BL2_df_smoothed['HorizontalFocusFWHM']*1000, label='Horizontal Focus Size', color='darkred', linestyle='dotted')
...
ax8.plot(BL1_df_smoothed['PhotonEnergy'], BL1_df_smoothed['VerticalFocusFWHM']*1000, label='Vertical Focus Size', color='lightgreen', linestyle='dashed')
ax8.plot(BL2_df_smoothed['PhotonEnergy'], BL2_df_smoothed['VerticalFocusFWHM']*1000, label='Vertical Focus Size', color='limegreen', linestyle='dotted')
...
fig.text(0.19, 0.7, '0.1 nm Roughness (solid lines)\n1 nm Roughness (dashed lines)\n3 nm Roughness (dotted lines)', fontsize=12, ha='right', va='top', bbox=dict(facecolor='white', alpha=0.8, edgecolor='grey'))
