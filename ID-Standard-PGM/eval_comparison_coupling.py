...
from parameter import rml_file_name_bessy3_standard_PGM_2Perc_coupling
from parameter import rml_file_name_bessy3_standard_PGM_10Perc_coupling
from parameter import rml_file_name_bessy3_standard_PGM_100Perc_coupling
...
rml_comparison_list = {}
rml_comparison_list[rml_file_name_bessy3_standard_PGM_2Perc_coupling]       = 1
rml_comparison_list[rml_file_name_bessy3_standard_PGM_10Perc_coupling]      = 1
rml_comparison_list[rml_file_name_bessy3_standard_PGM_100Perc_coupling]     = 1
...
fig.suptitle(f"BESSYIII PGM beamline comparison regard coupling")
