...
from parameter import rml_file_name_bessy3_HRRIXS_93m_errors_off as rml_file_name
...
# from parameter import bandwidth, bandwidth_unit


# define a list of dictionaries with the parameters to scan
params = [  
            {beamline.PG.cFactor:cff}, 
            # {beamline.SU.energySpread:bandwidth_unit},
            # {beamline.SU.energySpread:bandwidth},
