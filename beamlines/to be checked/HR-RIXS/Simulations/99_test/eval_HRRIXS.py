...
BL_file_path = os.path.join('RAYPy_Simulation_HRRIXS_91m_Versuch_3_w_err_FLUX', 'DetectorAtFocus_RawRaysOutgoing.csv')
...
ax4.set_title('Flux curve 93 m HRRIXS-Beamline')
...
# plt.savefig('plot/Flux_curves HRRIXS (91m) with UE42 @ BESSY III_with_errors.pdf')
plt.tight_layout()
plt.show()
