...
BL_file_path = os.path.join('RAYPy_Simulation_bessy3_56m_PGM_2Perc_coupl_err_on0_75deg_1200l_V3_1nm_rough_Au_FLUX', 'DetectorAtFocus_RawRaysOutgoing.csv')
...
fig.suptitle('UE42 BESSY III Standard PGM Beamline (56 m); all Au @ 1 nm roughness', size=14)
x_range = [50, 2150]
...
plt.savefig('plot/Flux_curves UE42 @ BESSY III_err_on_rough_1nm.pdf')
plt.tight_layout()
plt.show()
