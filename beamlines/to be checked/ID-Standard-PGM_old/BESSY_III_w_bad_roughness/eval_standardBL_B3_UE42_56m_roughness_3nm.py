...
BL_file_path = os.path.join('RAYPy_Simulation_bessy3_56m_PGM_2Perc_coupl_err_on0_75deg_1200l_V3_3nm_rough_Au_FLUX', 'DetectorAtFocus_RawRaysOutgoing.csv')
...
# plt.savefig('plot/Flux_curves UE42 @ BESSY III_err_on_rough_3nm.pdf')
plt.tight_layout()
plt.show()
