...
from parameter import elisa_vertical_file_path as rml_file
from parameter import elisa_vertical_sim_name as sim_name
from parameter import undulator
from parameter import energy_vertical as energy, rounds, ncpu   
from parameter import SlitSize_vertical, nrays
...
params = [  
            {beamline.ExitSlit.openingHeight:SlitSize_vertical},
