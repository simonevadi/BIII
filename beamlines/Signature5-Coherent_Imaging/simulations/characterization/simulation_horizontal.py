...
from parameter import elisa_horizontal_file_path as rml_file
from parameter import elisa_horizontal_sim_name as sim_name
from parameter import undulator
from parameter import energy_horizontal as energy, rounds, ncpu   
from parameter import SlitSize_horizontal, nrays
...
params = [  
            {beamline.ExitSlit.openingWidth:SlitSize_horizontal},
