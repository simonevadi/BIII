...
<<<<<<<< HEAD:beamlines/Signature1-SoTeXS/simulations/characterization/eval_2400_500nano.py
BL_file_path = os.path.join('RAYPy_Simulation_sotexs_2400_500nano', 'DetectorAtFocus_RawRaysOutgoing.csv')
========
BL_file_path = os.path.join('RAYPy_Simulation_sotexs_2400_nano_ML_NiB4C', 'DetectorAtFocus_RawRaysOutgoing.csv')
>>>>>>>> 24c93ef (fix eval, prepare new sim):beamlines/Signature1-SoTeXS/simulations/characterization/eval_2400_nano_ML_NiB4C.py
...
fig.suptitle('SoTeXS, 2400 l/mm, nano focus', size=16)
x_range = [500, 8000]
...
plt.tight_layout()
<<<<<<<< HEAD:beamlines/Signature1-SoTeXS/simulations/characterization/eval_2400_500nano.py
plt.savefig('plot/SoTeXS_2400_500nano.png')
========
plt.savefig('plot/SoTeXS_2400_nano_ML_NiB4C.png')
>>>>>>>> 24c93ef (fix eval, prepare new sim):beamlines/Signature1-SoTeXS/simulations/characterization/eval_2400_nano_ML_NiB4C.py
# plt.show()
