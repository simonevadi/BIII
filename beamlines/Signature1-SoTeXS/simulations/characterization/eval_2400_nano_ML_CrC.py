...
<<<<<<<< HEAD:beamlines/Signature1-SoTeXS/simulations/characterization/eval_2400_200nano.py
BL_file_path = os.path.join('RAYPy_Simulation_sotexs_2400_200nano', 'DetectorAtFocus_RawRaysOutgoing.csv')
========
BL_file_path = os.path.join('RAYPy_Simulation_sotexs_2400_nano_ML_CrC', 'DetectorAtFocus_RawRaysOutgoing.csv')
>>>>>>>> 24c93ef (fix eval, prepare new sim):beamlines/Signature1-SoTeXS/simulations/characterization/eval_2400_nano_ML_CrC.py
...
plt.tight_layout()
<<<<<<<< HEAD:beamlines/Signature1-SoTeXS/simulations/characterization/eval_2400_200nano.py
plt.savefig('plot/SoTeXS_2400_200nano.png')
========
plt.savefig('plot/SoTeXS_2400_nano_ML_CrC.png')
>>>>>>>> 24c93ef (fix eval, prepare new sim):beamlines/Signature1-SoTeXS/simulations/characterization/eval_2400_nano_ML_CrC.py
# plt.show()
