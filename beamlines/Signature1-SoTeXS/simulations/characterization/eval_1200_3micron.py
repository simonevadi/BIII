...
BL_file_path = os.path.join('RAYPy_Simulation_sotexs_1200_3micron', 'DetectorAtFocus_RawRaysOutgoing.csv')
...
# Save the the figure
plt.tight_layout()
<<<<<<< HEAD:beamlines/Signature1-SoTeXS/simulations/characterization/eval_1200_3micron.py
plt.savefig('plot/SoTeXS_1200_3micron.png')
plt.show()
=======
plt.savefig('plot/SoTeXS_1200.png')
# plt.show()
>>>>>>> 24c93ef (fix eval, prepare new sim):beamlines/Signature1-SoTeXS/simulations/characterization/eval_1200.py
