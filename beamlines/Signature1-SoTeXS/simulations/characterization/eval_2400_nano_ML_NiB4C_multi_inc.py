...
<<<<<<<< HEAD:beamlines/Signature1-SoTeXS/simulations/characterization/eval_2400_500nano_multi_inc.py
...
========
BL_file_path = os.path.join('RAYPy_Simulation_sotexs_2400_nano_ML_NiB4C_vary_incidence_angle_mirrors', 'DetectorAtFocus_RawRaysOutgoing.csv')
>>>>>>>> 24c93ef (fix eval, prepare new sim):beamlines/Signature1-SoTeXS/simulations/characterization/eval_2400_nano_ML_NiB4C_multi_inc.py
...
========
plt.savefig('plot/SoTeXS_2400_nano_ML_NiB4C_multi_inc.png')
>>>>>>>> 24c93ef (fix eval, prepare new sim):beamlines/Signature1-SoTeXS/simulations/characterization/eval_2400_nano_ML_NiB4C_multi_inc.py
# plt.show()
