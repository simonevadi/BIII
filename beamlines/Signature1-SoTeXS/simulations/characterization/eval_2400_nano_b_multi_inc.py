...
BL_file_path = os.path.join('RAYPy_Simulation_sotexs_2400_nano_b_vary_incidence_angle_mirrors', 'DetectorAtFocus_RawRaysOutgoing.csv')
...
colors = ['blue', 'orange', 'green', 'red', 'pink', 'cyan', 'black']
...
for theta in inc_angles:
    IrCrB4C_r, _ = get_reflectivity(IrCrB4C, E=E, theta=theta)
    ax1.plot(E, IrCrB4C_r, label=f'theta {theta}°')
...
# Save the the figure
plt.tight_layout()
plt.savefig('plot/SoTeXS_2400_nano_b_multi_inc.png')
plt.show()
