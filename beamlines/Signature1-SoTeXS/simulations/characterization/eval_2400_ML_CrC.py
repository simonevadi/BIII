...
<<<<<<<< HEAD:beamlines/Signature1-SoTeXS/simulations/characterization/eval_2400_3micron.py
BL_file_path = os.path.join('RAYPy_Simulation_sotexs_2400_3micron', 'DetectorAtFocus_RawRaysOutgoing.csv')
========
BL_file_path = os.path.join('RAYPy_Simulation_sotexs_2400_ML_CrC', 'DetectorAtFocus_RawRaysOutgoing.csv')
>>>>>>>> 24c93ef (fix eval, prepare new sim):beamlines/Signature1-SoTeXS/simulations/characterization/eval_2400_ML_CrC.py
...
plt.tight_layout()
<<<<<<<< HEAD:beamlines/Signature1-SoTeXS/simulations/characterization/eval_2400_3micron.py
plt.savefig('plot/SoTeXS_2400_3micron.png')
========
plt.savefig('plot/SoTeXS_2400_ML_CrC.png')
>>>>>>>> 24c93ef (fix eval, prepare new sim):beamlines/Signature1-SoTeXS/simulations/characterization/eval_2400_ML_CrC.py
# plt.show()
