...
BL_file_path = os.path.join('RAYPy_Simulation_HRRIXS_100m_blaze', 'DetectorAtFocus_RawRaysOutgoing.csv')
...
# Save the the figure
plt.tight_layout()
plt.savefig('plot/HRRIXS_100m_1_blazed.pdf')
plt.savefig('plot/HRRIXS_100m_1_blazed.png', dpi=600)
# plt.show()
