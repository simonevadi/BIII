...
from BESSY_II_HiBeta_machine_params import emittance_standard

# Define the values of the parameters to scan 
from parameter import ncpu, nrays, rounds
from parameter import B2_LoBeta_energy as energy
from parameter import B2_LoBeta_SlitSize as SlitSize
from parameter import B2_LoBeta_cff as cff
from parameter import B2_LoBeta_undulator as undulator
from parameter import B2_LoBeta_file_path as rml_file
from parameter import B2_LoBeta_sim_name
