...
from parameter import undulator_UE35_HL as undulator_df
...
BL_file_path = os.path.join('RAYPy_Simulation_elisa_2400_UE35', 'DetectorAtFocus_RawRaysOutgoing.csv')
...
ax2.set_title(f"UE35 Flux curve- min E {undulator_df[f'Energy1[eV]'].iloc[-1]}")
...
# Save the the figure
plt.tight_layout()
plt.savefig('plot/elisa_2400_UE35.png')
# plt.show()
plt.close()
