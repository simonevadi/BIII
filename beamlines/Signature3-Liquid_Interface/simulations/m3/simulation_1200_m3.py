...
from parameter import undulator, SlitSize_1200
from parameter import rounds, ncpu   
from parameter import cff_1200, nrays
...
sim.exports  =  [{beamline.ExitSlit:['RawRaysOutgoing']}]
