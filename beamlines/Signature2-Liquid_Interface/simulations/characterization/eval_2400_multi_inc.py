...
BL_file_path = os.path.join('RAYPy_Simulation_elisa_2400_vary_incidence_angle_mirrors', 'DetectorAtFocus_RawRaysOutgoing.csv')
...
fig.suptitle('elisa, 2400 l/mm, nano focus - M1: 600mm, M3: 500mm, KB_ver: 600mm, KB_hor:400, KB2_ver:500, KB2_hor:400')
x_range = [500, 8000]
...
# Save the the figure
plt.tight_layout()
plt.savefig('plot/elisa_2400_500nano_multi_inc.png')
# plt.show()
